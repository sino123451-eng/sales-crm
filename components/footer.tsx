    ...
    <footer className="border-t border-border bg-white pb-24 pt-10 md:pb-10">
      <div className="section-shell">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <nav className="flex flex-wrap items-center gap-y-2 text-sm font-bold text-primary-dark" aria-label="フッターナビゲーション">
            <a className="pr-4" href="#" aria-label="プライバシーポリシーを見る">プライバシーポリシー</a>
            <span className="h-4 w-px bg-border" aria-hidden="true" />
            <a className="pl-4" href="#" aria-label="お問い合わせページを見る">お問い合わせ</a>
          </nav>
        </div>
      </div>
    </footer>
